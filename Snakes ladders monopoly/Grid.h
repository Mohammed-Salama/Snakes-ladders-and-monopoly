...
public:
	...
	void SaveAll(ofstream &of ,ObjectType type);
	...
	Card* hasCard(int v, int h);

	bool IsOverLapping(GameObject* NewObj);

	/////////////////////////////////////////////this is added for bonus///////////////////////////////////////////////
	Player *GetPlayerFromNum(int n) const;     //Gets a pointer to a player from his number 
};
